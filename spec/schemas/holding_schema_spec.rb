...
RSpec.describe HoldingSchema do
  ...
  describe 'validates the holding field' do
    ...
    it 'accepts string value' do
      expect(validated.errors).not_to include(:holding)
    end
    ...
    context 'when holding is nil' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(holding: ['must be filled'])
      end
    end
  ...
  describe 'validates the symbol field' do
    ...
    it 'accepts string value' do
      expect(validated.errors).not_to include(:symbol)
    end
    ...
    context 'when symbol is absent' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(symbol: ['is missing'])
      end
    end
    ...
    context 'when symbol is nil' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(symbol: ['must be filled'])
      end
    end
  ...
  describe 'validates the sector name field' do
    ...
    it 'accepts string value' do
      expect(validated.errors).not_to include(:sector_name)
    end
  ...
  describe 'validates the numberofshares field' do
    ...
    it 'accepts decimal number value' do
      expect(validated.errors).not_to include(:numberofshares)
    end
    ...
    context 'when numberofshares is not a number' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(numberofshares: ['must be a decimal'])
      end
    end
    ...
    context 'when numberofshares is absent' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(numberofshares: ['is missing'])
      end
    end
    ...
    context 'when numberofshares is nil' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(numberofshares: ['must be filled'])
      end
    end
  ...
  describe 'validates the market value field' do
    ...
    it 'accepts decimal number value' do
      expect(validated.errors).not_to include(:market_value)
    end
    ...
    context 'when market value is not a number' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(market_value: ['must be a decimal'])
      end
    end
    ...
    context 'when market value is absent' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(market_value: ['is missing'])
      end
    end
    ...
    context 'when market value is nil' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(market_value: ['must be filled'])
      end
    end
  ...
  describe 'validates the market val percent field' do
    ...
    it 'accepts decimal number value' do
      expect(validated.errors).not_to include(:market_val_percent)
    end
    ...
    context 'when market val percent is not a number' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(market_val_percent: ['must be a decimal'])
      end
    end
    ...
    context 'when market val percent is absent' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(market_val_percent: ['is missing'])
      end
    end
    ...
    context 'when market val percent is nil' do
      ...
      it 'returns error' do
        expect(validated.errors).to include(market_val_percent: ['must be filled'])
      end
    end
